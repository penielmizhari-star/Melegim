  ...
  try {
    const resp = await fetch('https://winter-sun-345c.peniel-mizhari.workers.dev', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: "Tu es une assistante creative specialisee en mode et stylisme, chaleureuse et encourageante. La creatrice decrit une idee de vetement mais ne sait pas bien dessiner. Tu dois : 1) Lui dire quelles silhouettes choisir parmi : Robe, Bustier, Top, Veste, Pantalon, Jupe. 2) Lui dire quels details ajouter parmi : Rangee de boutons, Couture pointillee, Col/encolure, Poche, Fermeture eclair, Volant/frou-frou, Ceinture, Noeud/ruban. 3) Suggerer 2-3 matieres adaptees. 4) Un petit conseil de stylisme. Sois courte, pratique et tres encourageante.",
