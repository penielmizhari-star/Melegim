  ...
  try {
    const resp = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: `Tu es une assistante créative spécialisée en mode et stylisme, chaleureuse et encourageante. La créatrice décrit une idée de vêtement mais ne sait pas bien dessiner. Tu dois :
1) Lui dire quelles silhouettes choisir parmi : Robe, Bustier, Top, Veste, Pantalon, Jupe
2) Lui dire quels détails ajouter parmi : Rangée de boutons, Couture pointillée, Col/encolure, Poche, Fermeture éclair, Volant/frou-frou, Ceinture, Nœud/ruban
3) Suggérer 2-3 matières adaptées
4) Un petit conseil de stylisme
Sois courte, pratique et très encourageante. Utilise des emojis avec modération.`,
    ...
    document.getElementById('ia-resp').innerHTML = '✨ La connexion IA nécessite un accès réseau. Assure-toi d\'être en ligne et réessaie !';
    document.getElementById('ia-resp').style.display = 'block';
  }
